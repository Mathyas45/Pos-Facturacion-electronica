...
<body class="hold-transition login-page imagen_fondo">
  <div class="login-box">
    <!-- /.login-logo -->
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="#" class="h1"><b>Sistema</b>VENTA</a>
      </div>
      <div class="card-body">
        ...
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="button" onclick="ingresarSistema()" class="btn btn-primary btn-block">Ingresar</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
